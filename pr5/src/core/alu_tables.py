...
operands_tbl : Dict[OpCode, OperandFunc] = {
    ...
    Reg_ops.SLTU: lambda v_rs1, v_rs2, v_imm, v_pc: (v_rs1, v_rs2),

    Reg_ops.MUL: lambda v_rs1, v_rs2, v_imm, v_pc: (v_rs1, v_rs2),
    Reg_ops.MULH: lambda v_rs1, v_rs2, v_imm, v_pc: (v_rs1, v_rs2),
    Reg_ops.MULHSU: lambda v_rs1, v_rs2, v_imm, v_pc: (v_rs1, v_rs2),
    Reg_ops.MULHU: lambda v_rs1, v_rs2, v_imm, v_pc: (v_rs1, v_rs2),
    Reg_ops.DIV: lambda v_rs1, v_rs2, v_imm, v_pc: (v_rs1, v_rs2),
    Reg_ops.DIVU: lambda v_rs1, v_rs2, v_imm, v_pc: (v_rs1, v_rs2),
    Reg_ops.REM: lambda v_rs1, v_rs2, v_imm, v_pc: (v_rs1, v_rs2),
    Reg_ops.REMU: lambda v_rs1, v_rs2, v_imm, v_pc: (v_rs1, v_rs2),
    ...
    Upper_ops.LUI: lambda v_rs1, v_rs2, v_imm, v_pc: (v_imm, 12),
